...
const letterParagraphs = [
  "Since its establishment, ACM has played an important role in promoting regional collaboration, scientific exchange, and capacity building in the conservation and sustainable utilization of microbial resources across Asian countries. Under the theme “Harnessing Microbial Resources: From Single Cells to Microbiomes for a Sustainable Bioeconomy”, ACM23 will bring together scientists from diverse fields of microbiology to address global challenges related to environmental protection, circular economy, sustainable crop and livestock production, blue aquaculture, food safety, human health, and One Health. The meeting will provide an interdisciplinary platform for sharing recent scientific advances, innovative technologies, and opportunities for future collaboration.",
    ...
    <div className="bg-[#EAF2FB]">
      ...
      <article className="mx-auto max-w-4xl px-4 pb-14 pt-8 sm:px-6 sm:pb-20 sm:pt-12 lg:px-8">
        ...
        <div className="space-y-7">
          ...
          <p className={letterBodyTextClass}>
            On behalf of the Organizing Committee, it is my great pleasure to
            welcome you to the <Ordinal23 /> Annual Meeting of the Asian
            Consortium for the Conservation and Sustainable Use of Microbial
            Resources (ACM23), which will be held in Hanoi, Vietnam, in November
            2026.
          </p>
